        ...
        return this.each(function () {
            ...
            var setTargetValue = function () {
                ...
                if(minimumItemValue >= 0 && maximumItemValue >= 0) {
                    value=settings.minHintText+''+format(minimumItemValue)+settings.addtext+settings.maxHintText+' '+format(maximumItemValue)+settings.addtext;
                } else if(minimumItemValue >= 0) {
                    value=settings.minHintText+''+format(minimumItemValue)+settings.addtext;
            ...
            $(this).popover({
                ...
                content: function () {
                    ...
                    for(var i=0;i<settings.minValues.length;i++) {
                        minItems+='<li data-value="'+settings.minValues[i]+'">'+format(settings.minValues[i])+settings.addtext+'</li>';
                    }
                    minItems+='</ul>';
                    ...
                    for(var i=0;i<settings.maxValues.length;i++) {
                        maxItems+='<li data-value="'+settings.maxValues[i]+'">'+format(settings.maxValues[i])+settings.addtext+'</li>';
                    }
                    maxItems+='</ul>';
