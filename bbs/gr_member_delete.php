...
$sql = "select gm_id from g5_group_member where mb_id = '$mb_id'";
$result = sql_query($sql);
for ($i=0; $row3=sql_fetch_array($result); $i++) {

// 게시글 삭제
sql_query(" update g5_member set mb_2 = NULL where mb_id = '$mb_id' ");
sql_query(" update g5_group_member set 	gm_exit_date = '".G5_TIME_YMDHIS."' where gm_id = '{$row3['gm_id']}' ");

// sql_query(" delete from g5_group_member where gm_id = '{$row3['gm_id']}' ");
}
