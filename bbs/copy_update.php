...
$keyword = "wr_o_id,wr_num,wr_reply,wr_parent,wr_is_comment,wr_datetime,wr_subject,wr_writer,wr_writer_id,wr_hp,wr_sale_type,wr_sold_out,wr_sold_out_date,wr_content,wr_address,wr_address_sale,wr_district,wr_sale_area,wr_floor,wr_rent_p,wr_area_p,wr_area_m,wr_area_p_all,wr_area_m_all,wr_sale_price,wr_sale_price_b,wr_p_sale_price,wr_loan,wr_year_rate,wr_int_rate,wr_year_int,wr_mon_int,wr_year_income,wr_sale_deposit,wr_total_rfee,wr_rent_deposit,wr_profit_rate,wr_mon_income,wr_silinsu,wr_gross_area,wr_m_rate,wr_mt_cost,wr_mt_cost_p,wr_mt_separate,wr_mt_elec,wr_mt_water,wr_mt_gas,wr_mt_tv,wr_mt_internet,wr_premium_o,wr_premium_b,wr_renter_contact,wr_lessor_contact,wr_parcel_contact,wr_seller_contact,wr_rand_type,wr_zoning_district,wr_room_type,wr_rent_type,wr_room_number,wr_room_count,wr_rest_count,wr_o_air_cond,wr_o_fridger,wr_o_washer,wr_o_tv,wr_o_internet,wr_o_microwave,wr_o_desk,wr_o_bookshelf,wr_o_bed,wr_o_closet,wr_o_shoe_rack,wr_o_sink,wr_o_stove,wr_o_elock,wr_o_ind,wr_o_elevator,wr_o_vacant,wr_memo,wr_rec_sectors,wr_o_bidet,wr_code,wr_extra_exp,wr_adver_subject,wr_file,board_list,wr_important,wr_bookmark,wr_office_permission,wr_posx,wr_posy,wr_bld_match_id,wr_room_inactive,wr_move_date";
...
if(!$gr_admin){
sql_query("update $write_table set wr_important =  1,wr_office_permission = '1' where wr_id = $wr_id_list[$i] ");
}else if ($gr_admin){
sql_query("update $write_table set wr_important =  1 , wr_office_permission = 2, wr_move_date =  '".G5_TIME_YMDHIS."' where wr_id = $wr_id_list[$i] ");
}
} //for exit
?>
