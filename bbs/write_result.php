...
<? if($gr_admin){ ?>
  ...
  <?}else{?>
<a href="<?echo G5_BBS_URL?>/board.php?bo_table=<?=$bo_table?>&wr_sale_type=<?=$wr_sale_type?>&board_list=<?=$board_list?>&wr_important=<?=$write['wr_important']?>&wr_office_permission=<?$write['wr_office_permission']?>">
<span class="">매물리스트로가기</span>
</a>
<?}?>
