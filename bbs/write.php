...
if ($board_list == 1)
include_once ($board_skin_path.'/write.skin1.php') ;
elseif ($board_list == 2)
include_once ($board_skin_path.'/write.skin2.php');
elseif ($board_list == 3)
include_once ($board_skin_path.'/write.skin3.php');
elseif ($board_list == 4)
include_once ($board_skin_path.'/write.skin4.php');
