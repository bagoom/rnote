                      ...
                      <div class="tr" id="list_link" style="position:relative">
                        ...
                        <div class="td">
                          <?
                              ...
                              $reblock_href = "./gr_member_block.php?bo_table=$bo_table&mb_id=$row[mb_id]&gm_block=2";                            
                              ?>
                          ...
                          <input type="hidden" name="mb_id" value="<?=$row[mb_id]?>">
                            ...
                            <? if ($row['gm_block'] =='2'){ ?>
                            <a class='btn btn-danger btn-md block' href="<?php echo $reblock_href ?>"style="background:#4caf50">해제하기</a>
                            <?}else{?>
