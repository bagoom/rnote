...
if (!$gr_admin)
  goto_url(G5_HTTP_BBS_URL.'/board.php?bo_table='.$bo_table.'&wr_sale_type=1&board_list='.$write[board_list].'&wr_writer='.$member[mb_nick].'&wr_important='.$write[wr_important]);
