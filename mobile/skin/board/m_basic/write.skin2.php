                        ...
                        <div class="tab-content">
                          <div class="tab-pane active" id="rent">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-xs-6 col-sm-6 control-label2">방개수</label>
                                <!-- 층수 -->
                                <div class="col-xs-6">
                            ...
                            <div class="form-group">
                              <label class="col-xs-6 col-sm-6 control-label2">방향</label>
                              <label class="col-xs-6 col-sm-6 control-label2">주차</label>
                              <!-- 방향 -->
                                <div class="col-xs-6">
                            ...
                            <div class="form-group">
                              <label class="col-xs-6 col-sm-6 control-label2">건물주연락처</label>
                              <label class="col-xs-6 col-sm-6 control-label2">분양팀연락처</label>
                              <!-- 건물주연락처 -->
                                <div class="col-xs-6">
