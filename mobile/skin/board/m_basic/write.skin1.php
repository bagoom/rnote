...
<!----------------- 탭버튼 ---------------->
                        <div id="tab" class="btn-group" data-toggle="buttons" style="width:100%;">
                          <a href="#rent" class="btn btn-primary active" data-toggle="tab" style="width:50%; padding:14px 10px 10px 10px;">
                                      <input type="radio" />임대</a>
                          <a href="#sale" class="btn btn-primary" data-toggle="tab" style="width:50%; padding:14px 10px 10px 10px;">
...
<!----------------- 임대 내용 ---------------->
                        <div class="tab-content">
                          <div class="tab-pane active" id="rent">
                            ...
                            <div class="form-group">
                                ...
                                <!-- 매물명 -->
                                <div class="col-sm-10">
                                    <input type="text" name="wr_subject"  value="<?php echo $subject ?>" class="form-control"  tabindex="1"  autofocus/>
                            ...
                            <div class="form-group">
                                ...
                                <!-- 매물위치 -->
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" tabindex="2" name="wr_address"<?php echo $wr_address?> >
                                    <span class="help-block">매물위치를 입력 해 주세요.</span>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-xs-6 col-sm-12 control-label2">보증금</label>
                                <label class="col-xs-6 col-sm-12 control-label2">월세</label>
                                <div class="col-xs-6">
                                    <input type="text" name="wr_rent_deposit"  tabindex="3" value="<?php echo $wr_rent_deposit?>" id="wr_bo" class="form-control"  placeholder="만원" >
                                </div>
                            ...
                            <div class="form-group">
                              <label class="col-xs-6 col-sm-6 control-label2">권리금</label>
                            ...
                            <div class="form-group">
                              <label class="col-xs-6 col-sm-6 control-label2">방구조</label>
                              <label class="col-xs-6 col-sm-6 control-label2">인근전철역</label>
                              <!-- 방구조 -->
                                <div class="col-xs-6">
                        ...
                        <div class="modal-footer">
                          ...
                          <input type="submit" value="매물등록" id="btn_submit" accesskey="s" class="btn btn-primary" style="width:100%; padding:13px; text-align:center; margin-bottom:10px; margin-left:0;">
                        </div>
                      </form>
                      </div>
...
<!----------------- 매매 내용 ---------------->
                          <div class="tab-pane" id="sale">
                            ...
                            <div class="form-group">
                                ...
                                <!-- 매물명 -->
                                <div class="col-sm-10">
                                    <input type="text" name="wr_subject" id="wr_subject" value="<?php echo $wr_subject ?>" class="form-control" tabindex="0"  autofocus/>
                                    <span class="help-block">매물명을 입력 해 주세요.</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <label class="col-xs-6 col-sm-6 control-label2">연면적(m2)</label>
                                ...
                                <div class="col-xs-6">
                                  <!-- 연면적m2 -->
                                    <input type="text"  name="wr_area_m_all" value="<?php echo $wr_area_m_all ?>" id="wr_area_m_all" class="form-control" readonly  placeholder="m2">
                                </div>
                            </div>
