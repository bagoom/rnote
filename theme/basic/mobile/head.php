...
<? if($mobile_main == 2) {?>
  <header id="hd-list">
    <div class="mobile-pre-box">
      <a style="color:#fff;" href="javascript:history.go(-1)"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
    </div>
    <div class="mobile-toggle-box">
        <div class="fa fa-bars tooltips" data-placement="right" data-original-title="Toggle Navigation"></div>
    </div>
  <a href="<?php echo G5_URL?>"<sapn class="hd_logo" style="color:#fff;"><img src="<? G5_URL?>/img/mobile/mobile_logo_white.png" width="70px"></span></a>
  </header>
<? }else if($mobile_main == 3){ ?>
  <header id="hd-list">
    <div class="mobile-pre-box">
      <a style="color:#fff;" href="javascript:history.go(-1)"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
    </div>
  ...
  <sapn style="font-size:21px; color:#fff;"><?php echo $write['wr_code'] ?> </span>
  </header>
