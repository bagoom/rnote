      ...
      <header class="header black-bg">
        <div id="menubar">
          ...
          <div class="sub-menu">
            ...
            <? if ($gr_admin){ ?>
            <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=<? echo $member['mb_id']?>&board_list=3&wr_sale_type=1&wr_important=2&wr_writer=<?=$member[mb_name]?>">
          <?}else { ?>
            <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=<? echo $member['mb_id']?>&board_list=3&wr_sale_type=1&wr_important=2">
          <?}?>
            <div>
            ...
            <? if ($gr_admin){ ?>
            <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=<? echo $member['mb_id']?>&board_list=2&wr_sale_type=1&wr_important=2&wr_writer=<?=$member[mb_name]?>">
          <?}else { ?>
            <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=<? echo $member['mb_id']?>&board_list=2&wr_sale_type=1&wr_important=2">
          <?}?>
            <div>
            ...
            <? if ($gr_admin){ ?>
            <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=<? echo $member['mb_id']?>&board_list=4&wr_sale_type=1&wr_important=2&wr_writer=<?=$member[mb_name]?>">
          <?}else { ?>
            <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=<? echo $member['mb_id']?>&board_list=4&wr_sale_type=1&wr_important=2">
          <?}?>
            <div>
