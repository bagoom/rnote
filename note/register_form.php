...
if ($w == "") {
    ...
    if (!isset($_POST['agree']) || !$_POST['agree']) {
        alert('회원가입약관의 내용에 동의하셔야 회원가입 하실 수 있습니다.', G5_NOTE_URL.'/register.php');
    }

    if (!isset($_POST['agree2']) || !$_POST['agree2']) {
        alert('개인정보처리방침안내의 내용에 동의하셔야 회원가입 하실 수 있습니다.', G5_NOTE_URL.'/register.php');
    }
...
$register_action_url = G5_HTTPS_NOTE_URL.'/register_form_update.php';
