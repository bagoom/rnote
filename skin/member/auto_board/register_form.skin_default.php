...
<div class="mbskin" style="padding-bottom:0px;">
    ...
    <div class="tbl_frm01 tbl_wrap">
      <div class="caption">2. 개인정보 입력</div>
      <div class="reg_step">
                <?php if (!$w=='u'){ ?>
                <p class="holder">이름</p>
                <?}?>
                <input type="text"  id="reg_mb_name" name="mb_name" value="<?php echo $member['mb_nick'] ?>" <?php echo $required ?> >
                <input type="hidden"  name="mb_prev_name" value="<?php echo $member['mb_name'] ?>">

                <?php if (!$w=='u'){ ?>
                <p class="holder">휴대폰번호</p>
                <?}?>
                <input type="text"  name="mb_hp" style="border-top:1px solid #fff; " value="<?php echo $member['mb_hp'] ?>" id="reg_mb_hp" <?php echo $required ?>  class="frm_input minlength_3 <?php echo $required ?> " maxlength="20">
    ...
    $("#reg_mb_email").focus(function(){
          $(".mail_check").slideDown(200);
    });
    $("#reg_mb_email").blur(function(){
          $(".mail_check").slideUp(200);
    });
