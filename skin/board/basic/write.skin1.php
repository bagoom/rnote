...
.room_info_row input[type="number"]{
  font-size: 20px;
  text-align:right;
  color: #444;
  border: 0 ;
...
.room_btn_col input[type="checkbox"]{
  display: none;
}
.room_btn_col i{
  margin-right: 10px;
...
.room_btn_col label:first-child{
  margin-right: 10px;
}
.room_confirm_btn{
  margin-top: 30px; 
                                                  ...
                                                  <div class="auto_room_output">
                                                    ...
                                                    <div class="auto_room_input">
                                                          ...
                                                          <div class="room_info_row">
                                                                ...
                                                                <label for="wr_input_row">층수</label>
                                                                <p>층</p>
                                                                <input type="number" id="wr_input_row" placeholder="" min="1" max="10">
                                                                </div>

                                                                <div class="room_info_range">
                                                                <i class="fa fa-times" aria-hidden="true"></i>
                                                                </div>

                                                                <div class="room_info_col">
                                                                <label for="wr_input_col">방수</label>
                                                                <p>개</p>
...
<script src="<?php G5_PATH?>/assets/js/auto_room.js"></script>
<script>
