...
<div class="col-lg-12 main-list-wrap" >
          <div class="content_header">
            <div class="page_href">HOME >
              ...
              <span><strong>사무실매물승인</strong></span>
              <?}?>
            </div>
            ...
            <form name="fboardlist" id="fboardlist" action="./office_update.php"  method="post">
                  ...
                  <div class="board_list_box col-xs-12 col-md-12" id="list_style_list">
                    <div class="table">
                      <div class="thead">
                        ...
                        <div class="td"><? if($sale == '1') echo '상권명'; else echo '지목'?></div>
                        <div class="td"><? if($sale == '1') echo '층수'; else echo '지역지구'?></div>
                        <div class="td"><? if($sale == '1') echo '평수'; else echo '총면적'?></div>
                        <div class="td"><? if($sale == '1') echo '보증금'; else echo '총매도가'?></div>
                        <div class="td"><? if($sale == '1') echo '월세'; else echo '평당가격'?></div>
                        <div class="td"><? if($sale == '1') echo '권리금'; else echo '주소'?></div>
                        <? if ($sale == '2'){ ?>
                        <? if($_GET[wr_important] == 1){ ?>
                          <div class="td">담당자</div>
                        <?} }?>
                        <div class="td"><? if($sale == '1') echo '합계'; else echo '등록일'?></div>
                        <? if($sale == '1'){?><div class="td">주소</div><?}?>
                        <? if ($sale == '1'){ ?>
                        <? if( $_GET['wr_office_permission'] == '1' ){ ?>
                          <div class="td">담당자</div>
                        <?} }?>
                        <? if($sale == '1'){?><div class="td">등록일</div><?}?>
                      </div>
                      <div class="tbody">
                              <?php
                      ...
                      <div class="tr" id="list_link"onClick=location.href="<?php echo $list[$i]['href'] ?>" style="position:relative">
                        ...
                        <div class="td">
                          <?php  if($sale == '1') echo $list[$i]['wr_sale_area']; else echo $list[$i]['wr_rand_type']; ?>
                        </div>
                          <?php  if($sale == '1') {?>
                        <div class="td">
                        ...
                        <?} else{?>
                          ...
                          <?}?>
                        <div class="td">
                          <?php  if($sale == '1') echo $list[$i]['wr_area_p']; else echo $list[$i]['wr_area_p_all']; ?>
                        </div>
                        <div class="td">
                          <span class="commaN">
                          <?php  if($sale == '1') echo $list[$i]['wr_rent_deposit']; else echo $list[$i]['wr_sale_price']; ?>
                          </span>
                        </div>
                        <div class="td">
                          <span class="commaN">
                          <?php  if($sale == '1') echo $list[$i]['wr_m_rate']; else echo $list[$i]['wr_p_sale_price']; ?>
                        </div>
                          </span>
                        <div class="td">
                          <span class="commaN">
                          <?php  if($sale == '1') echo $list[$i]['wr_premium_o']; else{?>
                        </span>
                        ...
                        <div class="td">
                          <span class="commaN">
                          <?php  if($sale == '1') echo $list[$i]['wr_premium_o'] + $list[$i]['wr_rent_deposit']; else{?>
...
$(".select").change(function() {
  if ($(".select option:selected").val() == "기타사유입력"){
  $(".etc").slideDown(200);
}else{
  $(".etc").slideUp(200);
}
