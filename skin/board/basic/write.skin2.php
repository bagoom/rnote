                        ...
                        <div class="tab-content">
                          <div class="tab-pane active" id="rent">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-6 col-sm-6 control-label2">방개수</label>
                                <!-- 층수 -->
                                <div class="col-sm-6">
                                ...
                                <!-- 방개수 -->
                                <div class="col-sm-6">
                                    <input type="text" name="wr_room_count" value="<?php echo $wr_room_count?>" id="wr_room_count" class="form-control"  placeholder="개">
                                </div>
                            </div>

                            <div class="form-group">
                              <label class="col-sm-6 col-sm-6 control-label2">평수(P)</label>
                              <label class="col-sm-6 col-sm-6 control-label2">평수(m2)</label>
                                <!-- 평수p -->
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                              <label class="col-sm-6 col-sm-6 control-label2">매매가</label>
                              <label class="col-sm-6 col-sm-6 control-label2">평당매매가</label>
                              <!--  매매가-->
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                              <label class="col-sm-6 col-sm-6 control-label2">융자금액</label>
                              <label class="col-sm-6 col-sm-6 control-label2">인근전철역</label>
                              <!-- 융자금액 -->
                                <div class="col-sm-6">
                                ...
                                <!-- 인근전철역 -->
                                <div class="col-sm-6">
                                    <input type="text"  name="wr_o_subway" value="<?php echo $wr_o_subway ?>" id="wr_o_subway" class="form-control"  placeholder="역">
                                </div>
                            </div>

                            <div class="form-group">
                              <label class="col-sm-6 col-sm-6 control-label2">방향</label>
                              <label class="col-sm-6 col-sm-6 control-label2">주차</label>
                              <!-- 방향 -->
                                <div class="col-sm-6">
                                    <input type="text"  name="wr_direction" value="<?php echo $wr_direction ?>" id="wr_direction" class="form-control"  placeholder="향">
                                </div>
                                <!-- 주차 -->
                                <div class="col-sm-6">
                                    <input type="text"  name="wr_o_parking" value="<?php echo $wr_o_parking ?>" id="wr_o_parking" class="form-control"  placeholder="대">
                                </div>
                            </div>

                            <div class="form-group">
                              <label class="col-sm-6 col-sm-6 control-label2">건물주연락처</label>
                              <label class="col-sm-6 col-sm-6 control-label2">분양팀연락처</label>
                              <!-- 건물주연락처 -->
                                <div class="col-sm-6">
                                    <input type="text"  name="wr_lessor_contact" value="<?php echo $wr_lessor_contact ?>" id="wr_lessor_contact" class="form-control"  placeholder="">
                                </div>
                                <!-- 분양팀연락처 -->
                                <div class="col-sm-6">
                                    <input type="text"  name="wr_parcel_contact" value="<?php echo $wr_parcel_contact ?>" id="wr_parcel_contact" class="form-control"  placeholder="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                              <!-- 옵션 -->
                                <div class="col-sm-12">
                                    <p class="option_toggle"> 옵션추가하기 </p>
                                    <div class="option_contents" style="display:none;">
                                      <label>
                        						    <input type="checkbox" name="wr_o_air_cond" id="wr_o_air_cond" value="option1" >
                        						    에어컨
                        						  </label>

                                      <label>
                        						    <input type="checkbox" name="wr_o_fridger" id="wr_o_fridger" value="option1" >
                        						    냉장고
                        						  </label>

                                      <label>
                        						    <input type="checkbox" name="wr_0_washer" id="wr_0_washer" value="option1" >
                        						    세탁기
                        						  </label>

                                      <label>
                        						    <input type="checkbox" name="wr_o_tv" id="wr_o_tv" value="option1" >
                        						    TV
                        						  </label>

                                      <label>
                        						    <input type="checkbox" name="wr_o_internet" id="wr_o_internet" value="option1" >
                        						    인터넷
                        						  </label>

                                      <label>
                        						    <input type="checkbox" name="wr_o_microwave" id="wr_o_microwave" value="option1" >
                        						    전자렌지
                        						  </label>

                                      <label>
                        						    <input type="checkbox" name="wr_o_desk" id="wr_o_desk" value="option1" >
                        						    책상
                        						  </label>

                                      <label>
                        						    <input type="checkbox" name="wr_o_bookshelf" id="wr_o_bookshelf" value="option1" >
                        						    책장
                        						  </label>

                                      <label>
                        						    <input type="checkbox" name="wr_o_bed" id="wr_o_bed" value="option1" >
                        						    침대
                        						  </label>

                                      <label>
                        						    <input type="checkbox" name="wr_o_closet" id="wr_o_closet" value="option1" >
                        						    옷장
                        						  </label>

                                      <label>
                        						    <input type="checkbox" name="wr_o_shoe_rack" id="wr_o_shoe_rack" value="option1" >
                        						    신발장
                        						  </label>

                                      <label>
                        						    <input type="checkbox" name="wr_o_sink" id="wr_o_sink" value="option1" >
                        						    싱크대
                        						  </label>

                                      <label>
                        						    <input type="checkbox" name="wr_o_heating" id="wr_o_heating" value="option1" >
                        						    난방
                        						  </label>

                                      <label>
                        						    <input type="checkbox" name="wr_o_elevator" id="wr_o_elevator" value="option1" >
                        						    엘리베이터
                        						  </label>

                                      <label>
                        						    <input type="checkbox" name="wr_o_vacant" id="wr_o_vacant" value="option1" >
                        						    공실유무
                        						  </label>
                                    </div>
                                </div>
...
<!----------------- 매매 내용 ---------------->
                          <div class="tab-pane" id="sale">
                            ...
                            <div class="form-group">
                              <label class="col-sm-6 col-sm-6 control-label2">연면적(P)</label>
                              <label class="col-sm-6 col-sm-6 control-label2">연면적(m2)</label>
                                <!-- 연면적p -->
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                  <!-- 연면적m2 -->
                                    <input type="text"  name="wr_area_m_all" value="<?php echo $wr_area_m_all ?>" id="wr_area_m_all" class="form-control"  placeholder="m2">
                                </div>
                            </div>

                            <div class="form-group">
                              <label class="col-sm-6 col-sm-6 control-label2">총보증금</label>
                              <label class="col-sm-6 col-sm-6 control-label2">총임대료</label>
                              <!-- 총보증금 -->
                              <div class="col-sm-6">
                            ...
                            <div class="form-group">
                              <label class="col-sm-6 col-sm-6 control-label2">수익률</label>
                              <label class="col-sm-6 col-sm-6 control-label2">융자금액</label>
                              <!-- 수익률 -->
                              <div class="col-sm-6">
                            ...
                            <div class="form-group">
                              <label class="col-sm-6 col-sm-6 control-label2">층수</label>
                              <label class="col-sm-6 col-sm-6 control-label2">&nbsp</label>
                              <!-- 층수 -->
                              <div class="col-sm-6">
                                  <input type="text"  name="wr_floor" value="<?php echo $wr_floor ?>" id="wr_floor" class="form-control"  placeholder="층">
                              </div>
